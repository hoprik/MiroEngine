...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Gecolib3.geo.render.built.GeoQuad;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Gecolib3.geo.render.built.GeoVertex;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Gecolib3.item.GeoArmorItem;
...
public abstract class ExtendedGeoEntityRenderer<T extends LivingEntity & IAnimatable> extends GeoEntityRenderer<T> {
	...
	protected void handleArmorRenderingForBone(GeoBone bone, PoseStack stack, VertexConsumer buffer,
		...
		if (armorItem instanceof GeoArmorItem geoArmorItem) {
			...
			List<ModelPart.Cube> cubeList = null;
