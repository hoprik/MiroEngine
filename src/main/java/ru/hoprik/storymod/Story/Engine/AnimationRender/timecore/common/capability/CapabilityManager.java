...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.listener.EntityCapSyncOnStartTrackListener;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.listener.PlayerCapSyncOnJoinListener;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.listener.PlayerCapTransferOnCloneListener;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.owner.CapabilityOwner;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.owner.attach.CoffeeCapability;
...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.owner.attach.getter.StaticCoffeeCapabilityGetter;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.provider.IEnergyStorageProvider;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.provider.IFluidHandlerProvider;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.capability.provider.IItemHandlerProvider;
