...
public class ModelPart {
    ...
    public static class Cube {
        ...
        public Cube(int p_104343_, int p_104344_, float p_104345_, float p_104346_, float p_104347_, float p_104348_, float p_104349_, float p_104350_, float p_104351_, float p_104352_, float p_104353_, boolean p_104354_, float p_104355_, float p_104356_) {
            ...
            Vertex modelpart$vertex7 = new Vertex(p_104345_, p_104346_, p_104347_, 0.0F, 0.0F);
            Vertex modelpart$vertex = new Vertex(f, p_104346_, p_104347_, 0.0F, 8.0F);
            Vertex modelpart$vertex1 = new Vertex(f, f1, p_104347_, 8.0F, 8.0F);
            Vertex modelpart$vertex2 = new Vertex(p_104345_, f1, p_104347_, 8.0F, 0.0F);
            Vertex modelpart$vertex3 = new Vertex(p_104345_, p_104346_, f2, 0.0F, 0.0F);
            Vertex modelpart$vertex4 = new Vertex(f, p_104346_, f2, 0.0F, 8.0F);
            Vertex modelpart$vertex5 = new Vertex(f, f1, f2, 8.0F, 8.0F);
            Vertex modelpart$vertex6 = new Vertex(p_104345_, f1, f2, 8.0F, 0.0F);
            ...
            this.polygons[2] = new Polygon(new Vertex[]{modelpart$vertex4, modelpart$vertex3, modelpart$vertex7, modelpart$vertex}, f5, f10, f6, f11, p_104355_, p_104356_, p_104354_, Direction.DOWN);
            this.polygons[3] = new Polygon(new Vertex[]{modelpart$vertex1, modelpart$vertex2, modelpart$vertex6, modelpart$vertex5}, f6, f11, f7, f10, p_104355_, p_104356_, p_104354_, Direction.UP);
            this.polygons[1] = new Polygon(new Vertex[]{modelpart$vertex7, modelpart$vertex3, modelpart$vertex6, modelpart$vertex2}, f4, f11, f5, f12, p_104355_, p_104356_, p_104354_, Direction.WEST);
            this.polygons[4] = new Polygon(new Vertex[]{modelpart$vertex, modelpart$vertex7, modelpart$vertex2, modelpart$vertex1}, f5, f11, f6, f12, p_104355_, p_104356_, p_104354_, Direction.NORTH);
            this.polygons[0] = new Polygon(new Vertex[]{modelpart$vertex4, modelpart$vertex, modelpart$vertex1, modelpart$vertex5}, f6, f11, f8, f12, p_104355_, p_104356_, p_104354_, Direction.EAST);
            this.polygons[5] = new Polygon(new Vertex[]{modelpart$vertex3, modelpart$vertex4, modelpart$vertex5, modelpart$vertex6}, f8, f11, f9, f12, p_104355_, p_104356_, p_104354_, Direction.SOUTH);
        }
    ...
    public interface Visitor {
        void visit(PoseStack.Pose p_171342_, String p_171343_, int p_171344_, Cube p_171345_);
    }
}