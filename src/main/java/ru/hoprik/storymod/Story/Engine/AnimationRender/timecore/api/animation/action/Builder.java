package ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.animation.action;

import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.animation.AnimationStarter;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.animation.component.DelayedAction;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.animation.util.StandardDelayPredicates;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.animation.IAnimationWatcherInfo;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.animation.action.IDelayedAction.Handler;
