...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.animation.util.Empty;
...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.animation.TransitionFactoryWithDestination;
...
public class BasicAnimation extends Animation {
    ...
    @Override
    public @NotNull ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.animation.TransitionFactory getTransitionFactory() {
