...
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.reflection.provider.ClassHandler;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.reflection.provider.ClassHandlers;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.registry.TimeRegister;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.registry.VanillaRegister;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.registry.util.AutoRegistrable;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.registry.util.AutoRegistrable.Entries;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.registry.util.AutoRegistrable.Init;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.api.util.EnvironmentUtils;
import ru.hoprik.storymod.Story.Engine.AnimationRender.Timecore.common.KotlinAutomaticEventSubscriber;
